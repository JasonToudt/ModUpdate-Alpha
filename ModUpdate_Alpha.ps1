...
if (Test-Path -Path "C:\Users\$($localUser)\WinSCP\WinSCP-6.3.6-Automation\WinSCPnet.dll") {
    ...
    Invoke-RestMethod "https://github.com/JasonToudt/ModUpdate-v0.1/archive/refs/heads/main.zip" -OutFile "C:\Users\$($localUser)\Downloads\modupdate.zip"
